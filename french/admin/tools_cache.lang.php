...
$l['rebuild_reload_all'] = "(Tout reconstruire et synchroniser)";

$l['error_cannot_rebuild'] = "Ce cache ne peut pas être reconstruit.";
$l['error_empty_cache'] = "Le cache est vide.";
$l['error_incorrect_cache'] = "Le cache sélectionné est invalide.";
$l['error_no_cache_specified'] = "Aucun cache n’a été sélectionné.";

$l['success_cache_rebuilt'] = "Le cache a bien été reconstruit.";
$l['success_cache_reloaded'] = "Le cache a bien été resynchronisé.";
